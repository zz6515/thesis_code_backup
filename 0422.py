#较于0420重构了gdalclip函数，并且可以导出jpg格式的图片
...
class mainGUI(QMainWindow, GUI0):
    ...
    def gdalClip(self):
        ...
        '''
        self.tif_driver_path = 'Image_Clipped/'
    ...
    def exec_clipWithShp(self):
        ...
        for index, feat in enumerate(layer):
            ...
            createV = 'clipWithShp/shp/' + str(index) + '.shp'  # 新建矢量名称
            ...
            out_dataset = self.tif_driver.Create('clipWithShp/tif/' + str(index) + '.tif', block_sizeX, block_sizeY,
    ...
    def createShpAndClip(self):
        ...
        # 创建矢量
        createV = 'create_shp_clip/shp/' + str(self.image_count) + '.shp'  # 新建矢量名称
        ...
        out_dataset = self.tif_driver.Create('create_shp_clip/tif/' + str(self.image_count) + '.tif',
